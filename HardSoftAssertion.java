...
public class HardSoftAssertion {
    ...
    public void HardAssertion(){
        Assert.assertEquals(driver.getTitle(), "XYZ","Actual title and Expected title are not equal");
    ...
    public void SoftAssertion(){
        //create object soft for softassertion
        //object for softassertion
        SoftAssert soft = new SoftAssert();
        soft.assertEquals(driver.getTitle(), "XYZ","Actual title and Expected title are not equal");
        driver.findElement(By.xpath("//input[@id='user-name']")).sendKeys("problem_user");
        driver.findElement(By.xpath("//input[@id='password']")).sendKeys("secret_sauce");
        driver.findElement(By.xpath("//input[@id='login-button']")).click();
        soft.assertAll();
